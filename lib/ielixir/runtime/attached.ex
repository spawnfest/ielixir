defmodule IElixir.Runtime.Attached do
  ...
  def init(node, cookie \\ Node.get_cookie()) do
    ...
    case Node.ping(node) do
      :pong ->
        server_pid = IElixir.Runtime.ErlDist.initialize(node)
...
defimpl IElixir.Runtime, for: IElixir.Runtime.Attached do
  ...
  def duplicate(runtime) do
    case IElixir.Runtime.Attached.init(runtime.node, runtime.cookie) do
