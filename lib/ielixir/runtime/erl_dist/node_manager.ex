defmodule IElixir.Runtime.ErlDist.NodeManager do
  @moduledoc false

  # The primary IElixir process started on a remote node.
  #
  ...
  ## Options
    ...
    * `:unload_modules_on_termination` - whether to unload all
      IElixir related modules from the node on termination.
      Defaults to `true`.
  ...
  @doc """
  Starts a new `IElixir.Runtime.ErlDist.RuntimeServer` for evaluation.
  """
  ...
  def init(opts) do
    ...
    Logger.add_backend(IElixir.Runtime.ErlDist.LoggerGLBackend)
  ...
  def terminate(_reason, state) do
    ...
    Logger.remove_backend(IElixir.Runtime.ErlDist.LoggerGLBackend)
