defmodule IElixir.Runtime.ErlDist.LoggerGLBackend do
  @moduledoc false

  # A logger backend used to forward logs to IElixir,
  ...
  defp io_proxy?(pid) do
    ...
    info[:dictionary][:"$initial_call"] == {IElixir.Evaluator.IOProxy, :init, 1}
  end
