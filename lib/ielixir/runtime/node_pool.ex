defmodule IElixir.Runtime.NodePool do
  use GenServer
  ...
  ## Options
    ...
    - `:name` - The name the NodePool is locally registered as. By default, it is `IElixir.Runtime.NodePool`
  ...
  defp generate_name(state, basename) do
    new_name = :"#{IElixir.Utils.random_short_id()}-#{basename}"
