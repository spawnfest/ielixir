defmodule IElixir.Utils do
  ...
  ## Examples
      ...
      iex> get_in(list, [IElixir.Utils.access_by_id(2), Access.key(:name)])
      "Amy"

      iex> list = [%{id: 1, name: "Jake"}, %{id: 2, name: "Amy"}]
      iex> put_in(list, [IElixir.Utils.access_by_id(2), Access.key(:name)], "Amy Santiago")
      [%{id: 1, name: "Jake"}, %{id: 2, name: "Amy Santiago"}]

  An error is raised if the accessed structure is not a list:

      iex> get_in(%{}, [IElixir.Utils.access_by_id(1)])
      ** (RuntimeError) IElixir.Utils.access_by_id/1 expected a list, got: %{}
  """
  ...
  def access_by_id(id) do
    fn
      ...
      _op, data, _next ->
        raise "IElixir.Utils.access_by_id/1 expected a list, got: #{inspect(data)}"
    end
  end
  ...
  ## Examples
      ...
      iex> IElixir.Utils.valid_hex_color?("#111111")
      true

      iex> IElixir.Utils.valid_hex_color?("#ABC123")
      true

      iex> IElixir.Utils.valid_hex_color?("ABCDEF")
      false

      iex> IElixir.Utils.valid_hex_color?("#111")
      false
  """
  ...
  ## Examples
      ...
      iex> IElixir.Utils.upcase_first("sippin tea")
      "Sippin tea"

      iex> IElixir.Utils.upcase_first("short URL")
      "Short URL"

      iex> IElixir.Utils.upcase_first("")
      ""
  """
  ...
  ## Examples
      ...
      iex> IElixir.Utils.downcase_first("Sippin tea")
      "sippin tea"

      iex> IElixir.Utils.downcase_first("Short URL")
      "short URL"

      iex> IElixir.Utils.downcase_first("")
      ""
  """
  ...
  ## Examples
      ...
      iex> IElixir.Utils.expand_url("file:///home/user/lib/file.ex", "../root.ex")
      "file:///home/user/root.ex"

      iex> IElixir.Utils.expand_url("https://example.com/lib/file.ex?token=supersecret", "../root.ex")
  ...
  ## Examples
      ...
      iex> IElixir.Utils.wrap_line("cat on the roof", 7)
      "cat on\nthe\nroof"

      iex> IElixir.Utils.wrap_line("cat in the cup", 7)
      "cat in\nthe cup"

      iex> IElixir.Utils.wrap_line("cat in the cup", 2)
      "cat\nin\nthe\ncup"
  """
