defmodule IElixir.Evaluator.DefaultFormatter do
  @moduledoc false

  # The formatter used by IElixir for rendering the results.
  #
  # See `IElixir.Notebook.Cell` for available output formats.
  ...
  defp to_output(value) do
    # Kino is a "client side" extension for IElixir that may be
