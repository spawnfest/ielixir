defmodule IElixir.Completion do
  @moduledoc false

  # This module provides completion related operations
  # suitable for integration with a text editor.
  #
  # In a way, this provides the very basic features of a
  # language server that IElixir uses.

  alias IElixir.Completion.IdentifierMatcher
  ...
  @doc """
  Resolves an completion request as defined by `IElixir.Runtime`.

  In practice this function simply dispatches the request to one of
  the other public functions in this module.
  """
  @spec handle_request(
          IElixir.Runtime.completion_request(),
          Code.binding(),
          Macro.Env.t()
        ) :: IElixir.Runtime.completion_response()
  ...
  @spec get_completion_items(String.t(), Code.binding(), Macro.Env.t()) ::
          list(IElixir.Runtime.completion_item())
